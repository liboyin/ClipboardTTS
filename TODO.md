...
No task is currently expanded into a full boundary: NB4's was removed with its implementation commit. Suggested order: NB9; the remaining response work; settings/catalog simplification. This is priority guidance, not a phase fence — NB4 was taken ahead of NB9 because it was the one outstanding finding that leaked a credential, and it depended on nothing NB9 changes. Expand the assigned task into a boundary here before implementing it, and give every change its assigned scope.

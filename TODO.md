...
- Nine tasks are active in Phase 5: 38, 40, 42, 44–46, 48, 52, and 55. Task 36 was withdrawn
...
Phase 5 contains Tasks 38, 40, 42, 44–46, 48, 52, and 55: Task 38 is blocking; the rest are
...
starts only after Phase 4 closes. Task 38 is blocking; Tasks 40, 42, 44–46, 48, 52, and 55
...
app requests no voice discovery at all. See [README.md](README.md#build--test) for the
strict-concurrency scope both targets are now held to, and for the test-state, hosted-view, and
mock-scope ownership rules a later task must keep clean.
